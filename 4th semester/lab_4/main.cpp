...
// Функция для обхода графа в глубину и нахождения компоненты связности
void DFS(vector<vector<int>>& graph, vector<bool>& visited, int current, vector<int>& component) {
